...
<div className={`${
        ...
        >
          ...
          <ul className="space-y-4 md:space-y-2 md:h-[500px] overflow-scroll">
              ...
              >
                <li className="click">{`Raspberry Pi with ${experiments[0]}`}</li>
              </Link>
              <Link
             ...
             className="block px-4 py-2 rounded-md text-sm  text-blue-950 hover:bg-gray-200"
           >
             {`Raspberry Pi with ${experiments[1]}`}
           </Link>
           <Link
             ...
             className="block px-4 py-2 rounded-md text-sm  text-blue-950 hover:bg-gray-200"
           >
             {`Raspberry Pi with ${experiments[2]}`}
           </Link>
           <Link
             ...
             className="block px-4 py-2 rounded-md text-sm  text-blue-950 hover:bg-gray-200"
           >
             {`Raspberry Pi with ${experiments[3]}`}
           </Link>
           <Link
             ...
             className="block px-4 py-2 rounded-md text-sm  text-blue-950 hover:bg-gray-200"
           >
             {`Raspberry Pi with ${experiments[4]}`}
           </Link>
           <Link
             ...
             className="block px-4 py-2 rounded-md text-sm  text-blue-950 hover:bg-gray-200"
           >
             {`Raspberry Pi with ${experiments[5]}`}
           </Link>
           <Link
             ...
             className="block px-4 py-2 rounded-md text-sm  text-blue-950 hover:bg-gray-200"
           >
             {`Raspberry Pi with ${experiments[6]}`}
           </Link>
           <Link
             ...
             className="block px-4 py-2 rounded-md text-sm  text-blue-950 hover:bg-gray-200"
           >
             {`Raspberry Pi with ${experiments[7]}`}
           </Link>
